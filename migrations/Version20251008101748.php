 ...
 */
final class Version20251008101748 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domotic_capability_state RENAME COLUMN stateschema TO state_schema');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE domotic_capability_state RENAME COLUMN state_schema TO stateschema');
    }
}
