 ...
 */
final class Version20251008131153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domotic_device RENAME COLUMN technicalname TO technical_name');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domotic_device RENAME COLUMN technical_name TO technicalname');
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
    }
}
