 ...
 */
final class Version20251023133445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location_zone ALTER current_temperature DROP NOT NULL');
        $this->addSql('ALTER TABLE location_zone ALTER current_power_consumption DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE location_zone ALTER current_temperature SET NOT NULL');
        $this->addSql('ALTER TABLE location_zone ALTER current_power_consumption SET NOT NULL');
    }
}
