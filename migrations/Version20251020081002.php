 ...
 */
final class Version20251020081002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE location_zone (id UUID NOT NULL, type VARCHAR(32) NOT NULL, icon VARCHAR(32) NOT NULL, parent_zone_id VARCHAR(32) NOT NULL, orientation VARCHAR(32) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, label_value VARCHAR(255) NOT NULL, target_temperature_value DOUBLE PRECISION DEFAULT NULL, target_power_consumption_value DOUBLE PRECISION DEFAULT NULL, surface_area_value DOUBLE PRECISION DEFAULT NULL, color_value VARCHAR(9) DEFAULT NULL, metadata_value JSON NOT NULL, PRIMARY KEY(id))');
