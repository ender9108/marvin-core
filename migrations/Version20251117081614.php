 ...
 */
final class Version20251117081614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE device_device (id UUID NOT NULL, device_type VARCHAR(32) NOT NULL, status VARCHAR(32) NOT NULL, protocol VARCHAR(32) DEFAULT NULL, protocol_id UUID DEFAULT NULL, composite_type VARCHAR(16) DEFAULT NULL, composite_strategy VARCHAR(32) DEFAULT NULL, execution_strategy VARCHAR(32) DEFAULT NULL, child_device_ids JSON DEFAULT NULL, native_sub_groups JSON DEFAULT NULL, virtual_type VARCHAR(255) DEFAULT NULL, zone_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, last_seen_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_state_update_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, label_value VARCHAR(255) NOT NULL, description_value TEXT DEFAULT NULL, metadata_value JSON DEFAULT NULL, physical_address_value VARCHAR(100) NOT NULL, technical_name_value VARCHAR(255) NOT NULL, native_group_info_native_group_id VARCHAR(100) DEFAULT NULL, native_group_info_protocol_id UUID DEFAULT NULL, native_group_info_friendly_name VARCHAR(255) DEFAULT NULL, native_group_info_metadata JSON DEFAULT NULL, native_scene_info_native_scene_id VARCHAR(100) DEFAULT NULL, native_scene_info_protocol_id UUID DEFAULT NULL, native_scene_info_friendly_name VARCHAR(255) DEFAULT NULL, native_scene_info_group_id VARCHAR(100) DEFAULT NULL, native_scene_info_metadata JSON DEFAULT NULL, scene_states_value JSON DEFAULT NULL, virtual_config_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN device_device.native_group_info_protocol_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN device_device.native_scene_info_protocol_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE device_device_capability (id UUID NOT NULL, device_id UUID NOT NULL, capability VARCHAR(255) NOT NULL, state_name VARCHAR(128) NOT NULL, current_value JSON DEFAULT NULL, last_updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, metadata_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE device_pending_action (id UUID NOT NULL, device_id UUID NOT NULL, correlation_id UUID DEFAULT NULL, status VARCHAR(255) NOT NULL, capability VARCHAR(100) NOT NULL, action VARCHAR(100) NOT NULL, parameters JSON NOT NULL, result JSON DEFAULT NULL, error_message TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, timeout_seconds INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE location_zone (id UUID NOT NULL, parent_id UUID DEFAULT NULL, slug VARCHAR(255) NOT NULL, icon VARCHAR(50) DEFAULT NULL, type VARCHAR(16) NOT NULL, is_occupied BOOLEAN DEFAULT NULL, no_motion_counter INT NOT NULL, active_sensors_count INT NOT NULL, last_metrics_update TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, device_ids TEXT DEFAULT NULL, device_temperatures JSON NOT NULL, device_humidities JSON NOT NULL, device_power_consumptions JSON NOT NULL, orientation VARCHAR(32) DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, zone_name_value VARCHAR(100) NOT NULL, current_temperature_value NUMERIC(5, 2) DEFAULT NULL, current_power_consumption_value NUMERIC(10, 2) DEFAULT NULL, current_humidity_value NUMERIC(4, 2) DEFAULT NULL, target_temperature_value NUMERIC(5, 2) DEFAULT NULL, target_power_consumption_value NUMERIC(10, 2) DEFAULT NULL, target_humidity_value NUMERIC(4, 2) DEFAULT NULL, surface_area_value NUMERIC(8, 2) DEFAULT NULL, color_value VARCHAR(9) DEFAULT NULL, metadata_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE protocol_protocol (id UUID NOT NULL, transport_type VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, preferred_execution_mode VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, name_value VARCHAR(255) NOT NULL, configuration_value JSON NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE secret_secret (id UUID NOT NULL, scope VARCHAR(20) NOT NULL, category VARCHAR(30) NOT NULL, last_rotated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, expires_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, key_value VARCHAR(255) NOT NULL, value_value VARCHAR(255) NOT NULL, rotation_policy_management VARCHAR(255) NOT NULL, rotation_policy_rotation_interval_days INT NOT NULL, rotation_policy_auto_rotate BOOLEAN NOT NULL, rotation_policy_rotation_command VARCHAR(255) DEFAULT NULL, metadata_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_852263D5FF4925FB ON secret_secret (key_value)');
        ...
        $this->addSql('CREATE TABLE security_user (id UUID NOT NULL, email VARCHAR(500) NOT NULL, status VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, firstname_value VARCHAR(255) NOT NULL, lastname_value VARCHAR(255) NOT NULL, roles_value JSON NOT NULL, locale_value VARCHAR(2) DEFAULT NULL, theme_value VARCHAR(32) DEFAULT NULL, timezone_value VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE system_action_request (id UUID NOT NULL, correlation_id VARCHAR(255) NOT NULL, entity_type VARCHAR(32) NOT NULL, entity_id VARCHAR(64) NOT NULL, action VARCHAR(32) NOT NULL, status VARCHAR(32) NOT NULL, input JSON DEFAULT NULL, output TEXT DEFAULT NULL, error TEXT DEFAULT NULL, completed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN system_action_request.id IS \'(DC2Type:action_request_id)\'');
        $this->addSql('CREATE TABLE system_container (id UUID NOT NULL, type VARCHAR(64) NOT NULL, status VARCHAR(128) DEFAULT NULL, container_id VARCHAR(128) DEFAULT NULL, container_label VARCHAR(128) DEFAULT NULL, ports JSON NOT NULL, volumes JSON NOT NULL, last_synced_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, service_label_value VARCHAR(255) NOT NULL, allowed_actions_value JSON DEFAULT NULL, image_value VARCHAR(255) NOT NULL, metadata_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE system_worker (id UUID NOT NULL, type VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, command TEXT NOT NULL, num_procs INT DEFAULT NULL, uptime VARCHAR(64) DEFAULT NULL, last_synced_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, label_value VARCHAR(255) NOT NULL, allowed_actions_value JSON DEFAULT NULL, metadata_value JSON DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN system_worker.id IS \'(DC2Type:worker_id)\'');
        $this->addSql('CREATE TABLE messenger_domain_events (id BIGSERIAL NOT NULL, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION notify_messenger_domain_events() RETURNS TRIGGER AS $$
            BEGIN
                PERFORM pg_notify(\'messenger_domain_events\', NEW.queue_name::text);
                RETURN NEW;
            END;
        $$ LANGUAGE plpgsql;');
        $this->addSql('DROP TRIGGER IF EXISTS notify_trigger ON messenger_domain_events;');
        $this->addSql('CREATE TRIGGER notify_trigger AFTER INSERT OR UPDATE ON messenger_domain_events FOR EACH ROW EXECUTE PROCEDURE notify_messenger_domain_events();');
        $this->addSql('CREATE TABLE messenger_domain_commands (id BIGSERIAL NOT NULL, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION notify_messenger_domain_commands() RETURNS TRIGGER AS $$
            BEGIN
                PERFORM pg_notify(\'messenger_domain_commands\', NEW.queue_name::text);
                RETURN NEW;
            END;
        $$ LANGUAGE plpgsql;');
        $this->addSql('DROP TRIGGER IF EXISTS notify_trigger ON messenger_domain_commands;');
        $this->addSql('CREATE TRIGGER notify_trigger AFTER INSERT OR UPDATE ON messenger_domain_commands FOR EACH ROW EXECUTE PROCEDURE notify_messenger_domain_commands();');
        $this->addSql('CREATE TABLE messenger_marvin_to_manager (id BIGSERIAL NOT NULL, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION notify_messenger_marvin_to_manager() RETURNS TRIGGER AS $$
            BEGIN
                PERFORM pg_notify(\'messenger_marvin_to_manager\', NEW.queue_name::text);
                RETURN NEW;
            END;
        $$ LANGUAGE plpgsql;');
        $this->addSql('DROP TRIGGER IF EXISTS notify_trigger ON messenger_marvin_to_manager;');
        $this->addSql('CREATE TRIGGER notify_trigger AFTER INSERT OR UPDATE ON messenger_marvin_to_manager FOR EACH ROW EXECUTE PROCEDURE notify_messenger_marvin_to_manager();');
        $this->addSql('CREATE TABLE messenger_manager_to_marvin (id BIGSERIAL NOT NULL, body TEXT NOT NULL, headers TEXT NOT NULL, queue_name VARCHAR(190) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, available_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, delivered_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE OR REPLACE FUNCTION notify_messenger_manager_to_marvin() RETURNS TRIGGER AS $$
            BEGIN
                PERFORM pg_notify(\'messenger_manager_to_marvin\', NEW.queue_name::text);
                RETURN NEW;
            END;
        $$ LANGUAGE plpgsql;');
        $this->addSql('DROP TRIGGER IF EXISTS notify_trigger ON messenger_manager_to_marvin;');
        $this->addSql('CREATE TRIGGER notify_trigger AFTER INSERT OR UPDATE ON messenger_manager_to_marvin FOR EACH ROW EXECUTE PROCEDURE notify_messenger_manager_to_marvin();');
        ...
        $this->addSql('ALTER TABLE device_device_capability ADD CONSTRAINT FK_A18C3F5194A4C7D4 FOREIGN KEY (device_id) REFERENCES device_device (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
