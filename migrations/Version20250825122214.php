 ...
 */
final class Version20250825122214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE capability_capability_action (capability_id UUID NOT NULL, capability_action_id UUID NOT NULL, PRIMARY KEY(capability_id, capability_action_id))');
        $this->addSql('CREATE INDEX IDX_711B377F92043242 ON capability_capability_action (capability_id)');
        $this->addSql('CREATE INDEX IDX_711B377F3AD9EF42 ON capability_capability_action (capability_action_id)');
        $this->addSql('COMMENT ON COLUMN capability_capability_action.capability_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN capability_capability_action.capability_action_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE capability_state_schema (id UUID NOT NULL, label VARCHAR(255) NOT NULL, reference VARCHAR(128) NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN capability_state_schema.id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE capability_state_schema_capability_action (capability_state_schema_id UUID NOT NULL, capability_action_id UUID NOT NULL, PRIMARY KEY(capability_state_schema_id, capability_action_id))');
        $this->addSql('CREATE INDEX IDX_3964268F8B489AEE ON capability_state_schema_capability_action (capability_state_schema_id)');
        $this->addSql('CREATE INDEX IDX_3964268F3AD9EF42 ON capability_state_schema_capability_action (capability_action_id)');
        $this->addSql('COMMENT ON COLUMN capability_state_schema_capability_action.capability_state_schema_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN capability_state_schema_capability_action.capability_action_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('CREATE TABLE device_capability (device_id UUID NOT NULL, capability_id UUID NOT NULL, PRIMARY KEY(device_id, capability_id))');
        $this->addSql('CREATE INDEX IDX_1182A1F694A4C7D4 ON device_capability (device_id)');
        $this->addSql('CREATE INDEX IDX_1182A1F692043242 ON device_capability (capability_id)');
        $this->addSql('COMMENT ON COLUMN device_capability.device_id IS \'(DC2Type:uuid)\'');
        $this->addSql('COMMENT ON COLUMN device_capability.capability_id IS \'(DC2Type:uuid)\'');
        ...
        $this->addSql('ALTER TABLE capability_capability_action ADD CONSTRAINT FK_711B377F92043242 FOREIGN KEY (capability_id) REFERENCES capability (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE capability_capability_action ADD CONSTRAINT FK_711B377F3AD9EF42 FOREIGN KEY (capability_action_id) REFERENCES capability_action (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE capability_state_schema_capability_action ADD CONSTRAINT FK_3964268F8B489AEE FOREIGN KEY (capability_state_schema_id) REFERENCES capability_state_schema (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE capability_state_schema_capability_action ADD CONSTRAINT FK_3964268F3AD9EF42 FOREIGN KEY (capability_action_id) REFERENCES capability_action (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE device_capability ADD CONSTRAINT FK_1182A1F694A4C7D4 FOREIGN KEY (device_id) REFERENCES device (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE device_capability ADD CONSTRAINT FK_1182A1F692043242 FOREIGN KEY (capability_id) REFERENCES capability (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE capability_capability_action DROP CONSTRAINT FK_711B377F92043242');
        $this->addSql('ALTER TABLE capability_capability_action DROP CONSTRAINT FK_711B377F3AD9EF42');
        $this->addSql('ALTER TABLE capability_state_schema_capability_action DROP CONSTRAINT FK_3964268F8B489AEE');
        $this->addSql('ALTER TABLE capability_state_schema_capability_action DROP CONSTRAINT FK_3964268F3AD9EF42');
        $this->addSql('ALTER TABLE device_capability DROP CONSTRAINT FK_1182A1F694A4C7D4');
        $this->addSql('ALTER TABLE device_capability DROP CONSTRAINT FK_1182A1F692043242');
