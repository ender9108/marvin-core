 ...
 */
final class Version20251031150812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE system_action_request ALTER output TYPE TEXT');
        $this->addSql('ALTER TABLE system_action_request ALTER error TYPE TEXT');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE system_action_request ALTER output TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE system_action_request ALTER error TYPE VARCHAR(255)');
    }
}
