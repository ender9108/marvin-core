 ...
 */
final class Version20251001064427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE security_user (id UUID NOT NULL, status_id UUID NOT NULL, type_id UUID NOT NULL, email VARCHAR(500) NOT NULL, password VARCHAR(255) NOT NULL, firstname_value VARCHAR(255) NOT NULL, lastname_value VARCHAR(255) NOT NULL, roles_value JSON NOT NULL, locale_value VARCHAR(2) DEFAULT NULL, theme_value VARCHAR(32) DEFAULT NULL, created_at_value TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at_value TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
