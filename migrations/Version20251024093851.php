 ...
 */
final class Version20251024093851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE system_container ADD image_value VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE system_container DROP image');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
        $this->addSql('ALTER TABLE system_container ADD image VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE system_container DROP image_value');
    }
}
