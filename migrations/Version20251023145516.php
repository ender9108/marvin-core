 ...
 */
final class Version20251023145516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location_zone RENAME COLUMN orientation_value TO orientation');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE location_zone RENAME COLUMN orientation TO orientation_value');
        $this->addSql('ALTER TABLE security_user ALTER email TYPE VARCHAR(500)');
    }
}
