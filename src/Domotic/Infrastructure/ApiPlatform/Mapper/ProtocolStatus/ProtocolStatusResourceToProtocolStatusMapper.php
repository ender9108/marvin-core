...
readonly class ProtocolStatusResourceToProtocolStatusMapper implements MapperInterface
{
     ...
     */
    public function load(object $from, string $toClass, array $context): ProtocolStatus
    {
        $dto = $from;
    ...
    public function populate(object $from, object $to, array $context): ProtocolStatus
    {
        $dto = $from;
        $entity = $to;
