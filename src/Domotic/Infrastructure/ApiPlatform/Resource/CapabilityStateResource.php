...
#[ApiResource(
    ...
    stateOptions: new Options(entityClass: CapabilityState::class)
)]
...
final class CapabilityStateResource implements ApiResourceInterface
{
