...
#[AsCommand(
    name: 'marvin:domotic:list-capability-states',
    description: 'List of device capability states',
)]
final readonly class ListCapabilityStateCommand
{
    ...
    public function __invoke(
        ...
        try {
            $capabilities = $this->queryBus->handle(new GetCapabilityStateCollection());
