...
#[AsMapper(from: GetUserResource::class, to: User::class)]
readonly class GetUserResourceToEntity implements MapperInterface
{
    ...
    {
        assert($from instanceof GetUserResource);
