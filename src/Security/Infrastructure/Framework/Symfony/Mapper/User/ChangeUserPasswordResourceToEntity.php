...
#[AsMapper(from: ChangeUserPasswordResource::class, to: User::class)]
readonly class ChangeUserPasswordResourceToEntity implements MapperInterface
{
    ...
    {
        assert($from instanceof ChangeUserPasswordResource);
