...
#[AsCommand(
    name: 'marvin:system:stop-container',
    description: 'Stop a container',
)]
final readonly class StopContainerCommand
{
    ...
    public function __invoke(
        ...
        try {
            ...
            $io->success(sprintf('Container %s stop request sent successfully.', $containerId));
