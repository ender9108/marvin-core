...
#[AsCommand(
    name: 'marvin:system:exec-container',
    description: 'Execute a command in a container',
)]
final readonly class ExecContainerCommandCli
{
    ...
    public function __invoke(
        ...
        string $containerId,
        #[Argument(description: 'Command to execute', name: 'command')]
        string $commandToExec,
        #[Argument(description: 'Command arguments', name: 'args')]
        array $args = [],
        ...
        try {
            ...
            $io->success(sprintf(
                'Container %s exec command request sent successfully: %s %s',
                $containerId,
                $commandToExec,
                implode(' ', $args)
            ));
