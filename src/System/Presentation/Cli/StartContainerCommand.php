...
#[AsCommand(
    name: 'marvin:system:start-container',
    description: 'Start a container',
)]
final readonly class StartContainerCommand
{
    ...
    public function __invoke(
        ...
        try {
            ...
            $io->success(sprintf('Container %s start request sent successfully.', $containerId));
