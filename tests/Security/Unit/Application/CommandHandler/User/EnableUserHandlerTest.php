...
use Marvin\Security\Application\CommandHandler\User\EnableUserHandler;
...
final class EnableUserHandlerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new EnableUserHandler($this->userRepository);
    }

    public function testSuccessfulUserEnabling(): void
    {
        $userId = new UserId();
        $command = new EnableUser($userId);
        ...
        $this->assertEquals(UserStatus::ENABLED, $user->status);
    }
