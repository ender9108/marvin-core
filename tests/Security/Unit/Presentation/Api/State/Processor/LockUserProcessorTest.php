...
final class LockUserProcessorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->processor = new LockUserProcessor($this->microMapper, $this->syncCommandBus);
    }
    ...
    public function testSuccessfulUserLocking(): void
    {
        ...
        $this->syncCommandBus
            ->expects($this->once())
            ->method('handle')
            ->with($this->callback(function (LockUser $command) use ($userId) {
